...
class ESPModule : Module("ESP", ModuleCategory.Visual) {
    ...
    private val colorRed by intValue("Red", 255, 0..255)
    private val colorGreen by intValue("Green", 0, 0..255)
    private val colorBlue by intValue("Blue", 0, 0..255)

    // Display options
    private val showAllEntities by boolValue("Select All", false)
    private val showDistance by boolValue("Distance", true)
    private val showNames by boolValue("Nametags", true)

    // Box style options
    private val use2DBox by boolValue("2D Box", false)
    private val use3DBox by boolValue("3D Box", true)
    private val useCornerBox by boolValue("Corner Box", false)

    // Tracer options
    private val tracers by boolValue("Tracers", false)
    private val tracerBottom by boolValue("Bottom", true)
    private val tracerTop by boolValue("Top", false)
    private val tracerCenter by boolValue("Center", false)
